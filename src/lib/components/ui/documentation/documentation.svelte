...
<div class="flex min-h-screen flex-col">
	<header class="sticky top-14 z-40 border-b bg-white py-4 shadow-sm dark:bg-background lg:hidden flex items-center justify-between">
		<Drawer>
	...
	<div class="flex w-full flex-1">
		...
		<main class="prose max-w-4xl lg:px-4 flex-1 dark:prose-invert">
